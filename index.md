...
---
  ...
  <section class="hero container">
    ...
    <div class="row justify-content-center">
      <!-- Pagefind UI mount point (landing hero) -->
      <div id="search-div-hero" class="col-xs-12 col-sm-offset-2 col-sm-8 col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6 asna-search asna-search-hero"></div>
    </div>
  </section>
