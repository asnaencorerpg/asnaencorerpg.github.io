...
```
DclFld myString	Type (*String) myString = "Look at this example!"  // This causes an error.
```
...
```
DclFld myString Type (*String) // The value of myString is: "Look at this example!" 
myString = """Look at this example!"""
```
