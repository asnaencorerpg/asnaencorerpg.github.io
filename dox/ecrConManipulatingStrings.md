...
The underlying class for the [*String Type](./ecrConStrings.html) is the .NET [System.String](https://learn.microsoft.com/en-us/dotnet/api/system.string) class which provides many built-in methods to facilitate the comparison and manipulation of strings. It is now a trivial matter to get data about a string, or to create new strings by manipulating current strings. 
