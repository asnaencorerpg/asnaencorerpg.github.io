...
conversion occurs if a value other than `*True` or `*False` is assigned to a `*Boolean` variable.
- The property is a `*String` data type, and there are no constraints on the size or value of the string.
